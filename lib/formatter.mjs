...
export function parseWorkbook(data) {
  ...
  const {rows,header}=candidates[0]; const groups=new Map(); let total=0;
...
export function pdfDefinition(result,name) {
 return {
  ...
  content:[
   {text:'Сборочное задание FBS',fontSize:18,bold:true,margin:[0,0,0,5]},
